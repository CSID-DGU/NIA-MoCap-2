...
file_prefix = "../dataset/ntu_rgbd/nturgbd_s018_s032_matV2/"
save_prefix = "../result/motion_gan/ntu_rgbd/ground_truth/"
...
for cla in paramUtil.ntu_action_labels:
    filename = "S018C001P008R002A0" + str(cla) + ".mat" if cla < 100 else "S018C001P008R002A" + str(cla) + ".mat"
    filename = "S018C001P008R002A00" + str(cla) + ".mat" if cla < 10 else filename
    print(filename)
